      ...
      <Card sx={{ borderRadius: '3'}}>
        ...
        <CardActions sx={{display: 'flex', justifyContent: 'space-between', pb: '2'}}>
            ...
            <Box display='flex' gap={3}>
                ...
                <Button onClick={async () => await deleteActivity.mutateAsync(activity.id)} disabled={deleteActivity.isPending} size="medium" color='error' variant="contained">Delete</Button>
            </Box>
        </CardActions>
    </Card>
  )
